    ...
    <header className={`bg-papaya-green text-white ${montserrat.className} relative z-50`}>
      <div className="container mx-auto px-4 py-4 flex items-center">
        ...
        <Link href="/" className="flex items-center space-x-2 hover:opacity-90 transition-opacity flex-shrink-0">
          ...
          <h1 className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold tracking-wide leading-tight truncate max-w-[200px] sm:max-w-none">
            Papaya Academy, Inc.
          </h1>
        </Link>
        
        {/* Desktop Navigation */}
        <nav className="hidden lg:flex space-x-4 xl:space-x-6 items-center flex-1 justify-center">
        ...
        <button
          type="button"
          className="lg:hidden inline-flex items-center justify-center rounded-md border border-white/20 p-2 hover:bg-white/10 transition-colors ml-auto"
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-white/15 bg-papaya-green">
          <div className="container mx-auto px-4 py-4 space-y-3">
            ...
            <Link href="/" className="block py-2 font-semibold tracking-wide" onClick={() => setMobileMenuOpen(false)}>
              Home
            </Link>
            ...
            <Link href="/news" className="block py-2 font-semibold tracking-wide" onClick={() => setMobileMenuOpen(false)}>
              News
            </Link>

            <Link href="/contact" className="block py-2 font-semibold tracking-wide" onClick={() => setMobileMenuOpen(false)}>
              Contact
            </Link>
