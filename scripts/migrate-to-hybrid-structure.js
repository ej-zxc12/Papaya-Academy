...
const { collection, getDocs, doc, setDoc, query, where, getDoc, addDoc } = require('firebase/firestore');

/**
 * Migration Script: Convert from separate collections to hybrid student structure
 * 
 * This script:
 * 1. Reads existing grades from /grades collection
 * 2. Reads existing SF10 records from /sf10 collection  
 * 3. Creates/updates student documents with hybrid structure
 * 4. Migrates all data to student.academicRecords[schoolYear]
 */
