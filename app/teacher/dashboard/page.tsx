  ...
  useEffect(() => {
    ...
    const loadMockData = () => {
      ...
      const mockStudents: Student[] = [
        { id: '1', name: 'Ana Santos', grade: 'Grade 1', enrolledDate: '2024-01-15', attendance: [], grades: [] },
        { id: '2', name: 'Ben Reyes', grade: 'Kinder', enrolledDate: '2024-01-15', attendance: [], grades: [] },
        { id: '3', name: 'Cruz Martinez', grade: 'Pre-School', enrolledDate: '2024-01-15', attendance: [], grades: [] },
        { id: '4', name: 'Diana Lim', grade: 'Grade 6', enrolledDate: '2024-01-15', attendance: [], grades: [] },
        { id: '5', name: 'Eduardo Tan', grade: 'Grade 3', enrolledDate: '2024-01-15', attendance: [], grades: [] },
      ];
