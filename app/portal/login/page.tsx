...
import { Eye, EyeOff, LogIn, User, Lock, School, GraduationCap } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1B3E2A] focus:border-transparent outline-none transition"
            >
