...
const sampleArticle: NewsArticle = {
  id: 4,
  title: "Intermediate Vocal Solo",
  subtitle: "ROPRISA Competition 2025",
  date: "September 13, 2025",
  category: "Cultural Events",
  readTime: "3 minutes",
  featuredImage: "/images/vocal.jpg",
  imageAlt: "Intermediate Vocal Solo ROPRISA Competition",
  content: {
    introduction: "Mygs Filaro achieved 2nd Place in the Intermediate Vocal Solo Category under the guidance of coach Ms. Geen, showcasing exceptional vocal talent and dedication to musical excellence.",
    culturalPerformances: "The performance demonstrated remarkable vocal control and emotional expression, representing the highest standards of Papaya Academy's music program.",
    musicalExcellence: "Student's interpretation of the competition piece impressed judges and audience alike, earning recognition among talented performers from the region.",
    eventHighlights: [
      {
        title: "2nd Place Achievement",
        description: "Earned silver medal in competitive vocal solo category, demonstrating exceptional musical ability."
      },
      {
        title: "Professional Coaching",
        description: "Success attributed to excellent guidance from vocal coach Ms. Geen and dedicated practice."
      },
      {
        title: "Regional Recognition",
        description: "Represented Papaya Academy with distinction in prestigious ROPRISA competition."
      }
    ]
  },
  relatedArticles: [
            ...
            <div className="group relative h-[400px] md:h-[550px] rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                <div className="bg-white/95 backdrop-blur-md px-6 py-4 rounded-xl border border-white/20">
                  ...
                  <p className="text-sm font-semibold text-gray-800">{article.subtitle} - Musical Excellence</p>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  <div className="group bg-gradient-to-br from-papaya-green/5 to-papaya-yellow/5 rounded-2xl p-8 border border-papaya-green/20 hover:shadow-lg transition-all duration-300">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <h3 className="text-xl font-bold text-papaya-green">Vocal Performance</h3>
                    </div>
